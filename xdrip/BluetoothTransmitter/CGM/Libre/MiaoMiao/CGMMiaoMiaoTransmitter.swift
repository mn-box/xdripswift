                ...
                if let miaoMiaoResponseState = MiaoMiaoResponseType(rawValue: firstByte) {
                    ...
                    case .dataPacket:
                        ...
                        if rxBuffer.count >= 363  {
                            ...
                            // first off all see if the buffer contains patchInfo
                            ...
                            // TODO : is this also required for other types ?
                            if let libreSensorType = LibreSensorType.type(patchInfo: patchInfo), libreSensorType == .libre1 {
